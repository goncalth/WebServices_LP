...
import fr.tgoncalves.webservices.AppController;
...
public class showUsers extends AppCompatActivity {
    ...
    private String urlJsonArry = "http://android.tgoncalves.fr/userShow.php";

    private static String TAG = showUsers.class.getSimpleName();
