...
public class Subscribe extends AppCompatActivity {
    ...
    String HttpUrl = "http://android.tgoncalves.fr/userRegistration.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue = Volley.newRequestQueue(Subscribe.this);
        ...
        Register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(CheckEditText){
                    ...
                    Toast.makeText(Subscribe.this, "Please fill all form fields.", Toast.LENGTH_LONG).show();
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, HttpUrl,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String ServerResponse) {
                        ...
                        Toast.makeText(Subscribe.this, ServerResponse, Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError volleyError) {
                        ...
                        Toast.makeText(Subscribe.this, volleyError.toString(), Toast.LENGTH_LONG).show();
                    }
                }) {
            @Override
